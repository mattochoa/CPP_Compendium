...
<!-- cc:auto:home-next -->
1. [[Map — Errors & Contracts]] · *map* · `D11` — wave 0
2. [[Map — Concurrency]] · *map* · `D12` — wave 0
3. [[Map — Performance & the Machine]] · *map* · `D13` — wave 0
4. [[Map — Tooling & Engineering]] · *map* · `D14` — wave 0
5. [[Map — Design & Idioms]] · *map* · `D15` — wave 0
6. [[Map — Evolution of C++]] · *map* · `D16` — wave 0
<!-- cc:end -->
