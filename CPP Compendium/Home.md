...
<!-- cc:auto:home-next -->
1. [[Map — Program Structure & Build]] · *map* · `D01` — wave 0
2. [[Map — Types & Values]] · *map* · `D02` — wave 0
3. [[Map — Expressions & Control]] · *map* · `D03` — wave 0
4. [[Map — Functions]] · *map* · `D05` — wave 0
5. [[Map — Classes & Encapsulation]] · *map* · `D06` — wave 0
6. [[Map — Generic Programming]] · *map* · `D09` — wave 0
<!-- cc:end -->
